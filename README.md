...
<ul> 
    <li> <b>git init: </b>Inicia o git na pasta gerando o .git</li>
    ...
    <li> git add . : adiciona/atualiza os arquivos</li>
    ...
    <li> git checkout {nome da branch}: entra na branch</li>
    <li> git push origin {nome da branch}: manda para a branch que criei os arquivos</li>
</ul>
